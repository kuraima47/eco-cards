const CGU = () => {
    return (
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <p className="text-gray-600 text-sm text-center mb-4">En vigueur au 20/03/25</p>
  
        <div className="space-y-6">
          <section>
            <h2 className="font-bold">Article 1 : Mentions légales</h2>
            <p>L’édition et la direction de la publication du site site internet est assurée par Nicholas Journet (journet@labri.fr)</p>
          </section>
          
          <section>
            <h2 className="font-bold">Article 2 : Accès au site</h2>
            <p>
                Le site permet à l'Utilisateur un accès gratuit aux services suivants : création d'un compte, création de decks de carte, participation à des sessions de jeu
            ...
            <p>
                ...
                pas la responsabilité de site internet. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
          ...
          <section>
            <h2 className="font-bold">Article 3 : Collecte des données</h2>
            <p>
            ...
            <p>
                ...
                exerce ce droit par mail à l'adresse email journet@labri.fr
            </p>
          </section>
  
          <section>
            <h2 className="font-bold">Article 4 : Propriété intellectuelle</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold">Article 5 : Responsabilité</h2>
            <p>
                Les sources des informations diffusées sur le site site internet sont réputées fiables mais le site ne
            ...
            <p>
                ...
                Malgré des mises à jour régulières, le site site internet ne peut être tenu responsable de la
            ...
            <br/>
            <p>
                Le site site internet ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
          ...
          <section>
            <h2 className="font-bold">Article 6 : Liens hypertextes</h2>
            <p>
                Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces
                liens, il sortira du site site internet. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
                aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
            </p>
          </section>
  
          <section>
            <h2 className="font-bold">Article 7 : Cookies</h2>
            <p>
            ...
            <p>
                ...
                l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site site internet. Les cookies
            ...
            <br/>
            <p>
                L’information contenue dans les cookies est utilisée pour améliorer le site site internet.
            </p>
            <br/>
            <p>
          ...
          <section>
            <h2 className="font-bold">Article 8 : Publication par l’Utilisateur</h2>
            <p>Le site permet aux membres de publier des contenus comme des decks et cartes, ainsi que participer à des sessions de jeu</p>
            <br/>
            <p>
          ...
          <section>
            <h2 className="font-bold">Article 9 : Droit applicable et juridiction compétente</h2>
            <p>
            ...
            <br/>
            <p>
                CGU réalisées sur <a href="http://legalplace.fr/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">legalplace</a>.
            </p>
          </section>
        </div>
      </div>
