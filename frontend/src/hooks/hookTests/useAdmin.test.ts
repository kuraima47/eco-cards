...
describe('useAdmin', () => {
  ...
  const mockUser = { userId: 1, username: 'admin', email: 'admin@example.com', role: 'admin' as const };
  ...
  const mockCards = [
    { 
      ...
      cardImageData: new Uint8Array(),
      qrCodeColor: '#000000',
      qrCodeLogoImage: 'https://example.com/logo.png',
    ...
    const cardsToImport = [
      {
        ...
        currentSituation: ['Imported situation 1'],
        proposals: ['Imported proposal 1'],
        co2Saved: 10,
        backgroundColor: '#FFFFFF',
        textColor: '#000000',
        qrCodeColor: '#000000',
      ...
      },
      {
        ...
        currentSituation: ['Imported situation 2'],
        proposals: ['Imported proposal 2'],
        co2Saved: 20,
        backgroundColor: '#FFFFFF',
        textColor: '#000000',
        qrCodeColor: '#000000',
